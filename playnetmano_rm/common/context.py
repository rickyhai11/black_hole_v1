...
from playnetmano_rm.common import policy
...
def get_service_context(**args):
    ...
    There could be multiple cloud backends for playnetmano_rm to use. This
    abstraction layer provides an indirection for playnetmano_rm to get the
    credentials of 'playnetmano_rm' user on the specific cloud. By default,

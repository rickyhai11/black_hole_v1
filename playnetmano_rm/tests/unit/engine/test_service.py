...
from playnetmano_rm.engine import service
from playnetmano_rm.tests import base
from playnetmano_rm.tests import utils
...
class TestEngineService(base.KingbirdTestCase):
    def setUp(self):
        ...
        self.service_obj = service.EngineService('playnetmano_rm',
                                                 'playnetmano_rm-engine')

    def test_init(self):
        self.assertEqual(self.service_obj.host, 'localhost')
        self.assertEqual(self.service_obj.topic, 'playnetmano_rm-engine')

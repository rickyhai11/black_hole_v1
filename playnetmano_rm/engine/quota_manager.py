...
from playnetmano_rm.common import context
...
from playnetmano_rm.common import manager
...
class QuotaManager(manager.Manager):
    ...
    def periodic_balance_all(self, engine_id):
        ...
        lock = playnetmano_rm_lock.sync_lock_acquire(self.context, engine_id,
                                                     TASK_TYPE)
        if not lock:
        ...
        for current_batch_projects in utils.get_batch_projects(
            ...
            for current_project in current_batch_projects:
                ...
                for current_thread in projects_thread_list:
                    current_thread.join()
        playnetmano_rm_lock.sync_lock_release(self.context, engine_id, TASK_TYPE)

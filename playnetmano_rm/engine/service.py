...
from playnetmano_rm.common import messaging as rpc_messaging
from playnetmano_rm.engine.quota_manager import QuotaManager
from playnetmano_rm.engine import scheduler
from playnetmano_rm.objects import service as service_obj
        ...
        try:
            ...
            if svc is None:
                service_obj.Service.create(ctx, self.engine_id, self.host,
                                           'playnetmano_rm-engine', self.topic)

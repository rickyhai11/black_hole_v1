"""
Routines for configuring playnetmano_rm, (largely copy from Neutron)
"""
...
# from playnetmano_rm import policy
from playnetmano_rm.common import version
...
common_opts = [
    ...
    cfg.StrOpt('state_path',
               ...
               help='Top-level directory for maintaining playnetmano_rm state'),
...
def init(args, **kwargs):
    ...
    cfg.CONF(args=args, project='playnetmano_rm',
...
def reset_service():
    ...
    # TODO(rickyhai) enforce policy later
    # policy.refresh()
